...
const Modal = ({ children, headerBg }) => {
  ...
  if (modalOpen)
    return (
      <div
        className={`fixed inset-0 top-[0px] sm:top-0 sm:z-50 flex items-center justify-center rounded-xl z-[99]`}
      >
        ...
        >
          ...
          {modalConfig.withHeader && (
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.NEXT_PUBLIC_ASSET_REVERSE}${modalConfig.headerBg})`,
