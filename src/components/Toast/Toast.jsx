...
const Toast = ({
  ...
  return (
    <>
      <div
        className={`
          fixed transition-all duration-500 ease-in-out right-[25px] bottom-[75px] p-3 ${
            showToast
              ? "opacity-100 translate-y-0 z-[9999999999] sm:z-50 "
              : "opacity-0 translate-y-10 -z-[9999999999] sm:-z-50 "
