			...
			<div className="flex gap-3 items-center self-stretch my-auto min-w-[240px]">
				<div className="flex gap-2 items-center relative ">
					<img
						...
						alt=""
						className="object-contain shrink-0 self-stretch my-auto w-4 aspect-square absolute left-2 top-2"
					/>
					<input
						type="text"
						placeholder="Cari nama produk/SKU"
						onChange={onSearch}
						className="flex-1 shrink self-stretch  basis-0  pr-3 pl-7 py-2 my-auto bg-white rounded-md border border-solid border-neutral-500 min-h-[32px] min-w-[240px] w-[262px]"
