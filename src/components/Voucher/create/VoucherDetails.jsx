								...
								<input
									...
									className={`flex-1 ${
										formData.discountType === "Nominal"
											? "pl-10"
											: ""
									} shrink gap-2 self-stretch p-3 bg-white max-h-[32px] text-neutral-500 border rounded w-full disabled:bg-neutral-200 text-neutral-900 ${
								...
								<input
									...
									className={`flex-1 pl-10 shrink gap-2 self-stretch p-3 bg-white max-h-[32px] w-full text-neutral-500 border rounded ${
										isFieldError("minPurchase")
											? "border-red-500 focus:outline-0"
											: "border-neutral-500"
									} disabled:bg-neutral-200 text-neutral-900`}
						...
						<div className="flex gap-2 items-center w-60">
							<div className="flex flex-col flex-1 shrink self-stretch my-auto w-full basis-0">
								<input
									...
									name="quota"
									type="text"
									className={`flex-1 text-neutral-900 shrink gap-2 self-stretch p-3 w-full leading-tight bg-white rounded-md border border-solid ${
										isFieldError("quota")
						...
						<div className="flex flex-col w-60 justify-center">
							...
							{!isEdit && (
								<input
									...
									name="quotaPerBuyer"
									type="text"
									className={`flex shrink text-neutral-900 gap-2 self-stretch p-3 w-60 leading-tight bg-white rounded-md border border-solid ${
