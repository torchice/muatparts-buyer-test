					...
					{formData.productTarget === "specific" && (
						<>
							{selectedProducts.length > 0 ? (
								<>
									<div className="flex flex-wrap gap-10 justify-between items-center w-full leading-tight max-md:max-w-full">
										<SearchFilter
										...
										/>
										<div className="flex gap-3 items-center self-stretch my-auto text-sm font-semibold min-w-[240px]">
											<button
												type="button"
