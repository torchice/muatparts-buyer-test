...
const SliderBubbleFilter = ({
	...
	const FilterChip = ({ label }) => (
		<div className="flex gap-1 items-center px-[12px] py-[6px] bg-white rounded-2xl border border-blue-600 max-h-[28px] whitespace-nowrap">
			<div className="text-blue-600">{label}</div>
			<button
				onClick={() => onRemoveFilter(label)}
				className="focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-full p-0.5"
