                        ...
                        >
                          <div className="flex flex-col gap-3">
                            ...
                            {!!(data?.Data?.stores?.length && getSearch) && (
                              <div className="flex flex-col">
                                {/*  25. 03 - QC Plan - Web - Pengecekan Ronda Muatparts - Tahap 2 - LB - 0639 */}
                                <span className="bold-sm">{t("LabelsearchBarDropdownCariPenjual")}</span>
                                <ul className="list-none">
                            ...
                            !isLoading ? (
                              ...
                              >
                                <span className="text-neutral-600 semi-base">
                                  ...
                                  {t(
                                    "LabelsearchBarDropdownHasilPencarianTidakDitemukan"
                                  )}
                                </span>
                              </DataNotFound>
                            ) : (
                            ...
                            {getSearch && (
                              <div className="flex flex-col">
                                <span className="bold-sm">
                                  {t(
                                    "LabelsearchBarDropdownAlternatifPencarian"
                                  )}
                                </span>
                                <ul className="list-none">
                                  <li>
                                    ...
                                    >
                                      ...
                                      <span className="medium-xs">
                                        {t(
                                          "LabelsearchBarDropdownCarisemuaproduk"
                                        )}{" "}
                                        <b>{getSearch}</b>
                                      </span>
                                    </div>
                                  ...
                                  <li>
                                    ...
                                    >
                                      ...
                                      <span className="medium-xs">
                                        {t(
                                          "LabelsearchBarDropdownCarisemuaprodukdanprodukdenganalias"
                                        )}{" "}
                                        <b>“{getSearch}”</b>
                                      </span>
                                    </div>
                          ...
                          {!!(
                            ...
                            <div className="w-full flex flex-col gap-3">
                              <p className="font-bold text-sm text-neutral-900">
                                {t(
                                  "LabelsearchBarDropdownPromoyangpalingbanyakdicari"
                                )}
                              </p>
                              {banner_search?.Data?.Image && (
                                <CustomLink
