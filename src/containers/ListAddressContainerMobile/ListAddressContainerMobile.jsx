...
import AddressCardMobileSkeleton from '../AddressCardMobile/AddressCardMobileSkeleton';
...
function ListAddressContainerMobile({address,onSave,onAddAddress,hideSearch=false,onChange,onChoose,preventDefaultSelected=false}) {
    ...
    const { data: userLocation, isLoading, isValidating } = useSWRHook(
                ...
                <>
                    ...
                    <>
                        <div className="bg-neutral-50 w-full pb-4 containerMobile">
                            <Input disabled icon={{left:<IconComponent loader={false} src={'/icons/search.svg'} height={16} width={16}/>}} value={search} changeEvent={a=>setSearch(a.target.value)} placeholder={t('LabelnavbarResponsiveCarinamaalamatyangdisimpan')} classname={'h-8'} />
                        </div>
