...
function KompatibilitasScreen({data,getExpanded,handleExpanded}) {
  ...
  return (
    <div className='w-full bg-neutral-200 flex flex-col gap-2 pb-4'>
        <div className='flex flex-col gap-4 w-full bg-neutral-50 containerMobile h-screen'>
            {
                data?.length?<></>:<DataNotFound title={t("LabelmodalKompatibilitasScreenTidakAdaDataKompatibilitas")} />
            }
